...
import pytest
from product.utils import IntConverter, StrAlnumConverter
...
class TestIntConverter:
    ...
    def test_ok(self, input_val, output_val):
    ...
    def test_include_boolean_ok(self, input_val, output_val):
    ...
    def test_convert_ok(self, input_val, output_val):
        handle = IntConverter()
    ...
    def test_convert_include_boolean_ok(self, input_val, output_val):
        handle = IntConverter()
        result = handle.convert(input_val, include_bool_str=True)
        assert result == output_val


class TestStrAlnumConverter:
    @pytest.mark.parametrize(
        "input_val, output_val",
        [
            ("a", "a"),
